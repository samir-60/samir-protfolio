...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(e,t,n){let r=new Float32Array(Ya),i=new q(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Ii({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Ii({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
	...
	`}var mo=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `}bindEvents(){let e=this.container.querySelector(`#sliderPrevBtn`),t=this.container.querySelector(`#sliderNextBtn`),n=this.container.querySelectorAll(`.slider-tab-segment`),r=this.container.querySelector(`.masculine-slider-card`);e&&e.addEventListener(`click`,()=>{this.goToSlide(this.currentSlide-1),tl.playClick()}),t&&t.addEventListener(`click`,()=>{this.goToSlide(this.currentSlide+1),tl.playClick()}),n.forEach(e=>{e.addEventListener(`click`,()=>{let t=parseInt(e.getAttribute(`data-slide-to`),10);this.goToSlide(t),tl.playClick()})}),r&&(r.addEventListener(`mouseenter`,()=>{this.isPaused=!0}),r.addEventListener(`mouseleave`,()=>{this.isPaused=!1}),r.addEventListener(`touchstart`,e=>{this.touchStartX=e.changedTouches[0].screenX},{passive:!0}),r.addEventListener(`touchend`,e=>{this.touchEndX=e.changedTouches[0].screenX,this.handleSwipe()},{passive:!0}))}handleSwipe(){let e=this.touchStartX-this.touchEndX;Math.abs(e)>45&&(e>0?this.goToSlide(this.currentSlide+1):this.goToSlide(this.currentSlide-1),tl.playClick())}goToSlide(e){this.currentSlide=e<0?this.totalSlides-1:e>=this.totalSlides?0:e,this.updateUI()}updateUI(){let e=this.container.querySelector(`#sliderTrack`),t=this.container.querySelector(`#sliderCounter`),n=this.container.querySelectorAll(`.masculine-slide`),r=this.container.querySelectorAll(`.slider-tab-segment`);e&&(e.style.transform=`translateX(-${this.currentSlide*100}%)`),t&&(t.textContent=`0${this.currentSlide+1} / 0${this.totalSlides}`),n.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentSlide)}),r.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentSlide)})}startAutoPlay(){this.autoPlayInterval&&clearInterval(this.autoPlayInterval),this.autoPlayInterval=setInterval(()=>{this.isPaused||this.goToSlide(this.currentSlide+1)},6e3)}},sl=class{constructor(e){this.container=document.getElementById(e),this.currentIndex=0,this.timer=null,this.slideInterval=null,this.isPaused=!1,this.totalSlides=4,this.telemetryData={ip:`Detecting...`,city:`Locating...`,country:`Global`,countryCode:``,flag:`🌐`,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone||`UTC`,utcOffset:``,localTime:`--:--:-- --`,localDate:`---, --- --, ----`,dayOfWeek:`---`,latency:`12ms`},this.container&&this.init()}async init(){this.updateClock(),this.timer=setInterval(()=>this.updateClock(),1e3),await this.fetchGeoData(),this.render(),this.startSliding()}async fetchGeoData(){try{let e=await fetch(`https://ipapi.co/json/`,{cache:`force-cache`});if(e.ok){let t=await e.json();t&&t.city&&(this.telemetryData.ip=t.ip||`Secured IP`,this.telemetryData.city=t.city,this.telemetryData.country=t.country_name||t.country,this.telemetryData.countryCode=t.country_code||``,this.telemetryData.timezone=t.timezone||this.telemetryData.timezone,this.telemetryData.utcOffset=t.utc_offset||``,this.telemetryData.flag=this.getCountryFlag(t.country_code))}}catch{let e=(Intl.DateTimeFormat().resolvedOptions().timeZone||`UTC`).split(`/`);this.telemetryData.city=e[1]?.replace(/_/g,` `)||`Global`,this.telemetryData.country=e[0]?.replace(/_/g,` `)||`Web Node`,this.telemetryData.flag=`🌐`}this.updateClock()}getCountryFlag(e){if(!e||e.length!==2)return`🌐`;let t=e.toUpperCase().split(``).map(e=>127397+e.charCodeAt(0));return String.fromCodePoint(...t)}updateClock(){try{let e=new Date,t=new Intl.DateTimeFormat(`en-US`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!0,timeZone:this.telemetryData.timezone}).format(e),n=new Intl.DateTimeFormat(`en-US`,{month:`short`,day:`numeric`,year:`numeric`,timeZone:this.telemetryData.timezone}).format(e),r=new Intl.DateTimeFormat(`en-US`,{weekday:`long`,timeZone:this.telemetryData.timezone}).format(e);this.telemetryData.localTime=t,this.telemetryData.localDate=n,this.telemetryData.dayOfWeek=r;let i=this.container?.querySelectorAll(`.live-time-ticker`),a=this.container?.querySelectorAll(`.live-date-ticker`),o=this.container?.querySelectorAll(`.live-day-ticker`);i?.forEach(e=>{e.textContent=t}),a?.forEach(e=>{e.textContent=n}),o?.forEach(e=>{e.textContent=r})}catch{let e=new Date;this.telemetryData.localTime=e.toLocaleTimeString(),this.telemetryData.localDate=e.toLocaleDateString()}}render(){if(!this.container)return;this.container.innerHTML=`
  ...
  `).join(``))}function Sl(){let e=document.getElementById(`typewriterTarget`);if(!e)return;let t=[`Full-Stack Web Developer`,`Cybersecurity Expert & Fraud Analyst`,`Founder of Softyx (softyx.shop)`,`B.Sc. CSE Student @ Metropolitan University`,`Architect of Profix & Shine UK`,`Academic AI Researcher & Open-Source Builder`],n=0,r=0,i=!1,a=75;function o(){let s=t[n];i?(e.textContent=s.substring(0,r-1),r--,a=35):(e.textContent=s.substring(0,r+1),r++,a=75),!i&&r===s.length?(i=!0,a=2e3):i&&r===0&&(i=!1,n=(n+1)%t.length,a=350),setTimeout(o,a)}o()}function Cl(){let e=document.querySelectorAll(`.stat-number`),t=!1,n=new IntersectionObserver(n=>{n.forEach(n=>{n.isIntersecting&&!t&&(t=!0,e.forEach(e=>{let t=parseInt(e.getAttribute(`data-target`),10),n=e.innerText.replace(/[0-9]/g,``),r=0,i=t/60,a=setInterval(()=>{r+=i,r>=t?(e.innerText=t+n,clearInterval(a)):e.innerText=Math.floor(r)+n},25)}))})},{threshold:.3}),r=document.querySelector(`.stats-banner`);r&&n.observe(r)}function wl(){let e=document.querySelectorAll(`.skill-bar-fill`),t=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&e.forEach(e=>{let t=e.getAttribute(`data-level`);e.style.width=`${t}%`})})},{threshold:.2}),n=document.getElementById(`skills`);n&&t.observe(n)}function Tl(){let e=document.querySelectorAll(`.story-tab-btn`),t=document.querySelectorAll(`.story-tab-content`);e.forEach(n=>{n.addEventListener(`click`,()=>{e.forEach(e=>e.classList.remove(`active`)),t.forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),tl.playClick();let r=n.getAttribute(`data-tab`),i=document.getElementById(`tab-${r}`);i&&i.classList.add(`active`)})})}function El(){let e=document.getElementById(`themeDropdown`),t=document.getElementById(`themeBtn`),n=document.querySelectorAll(`.theme-item`),r=localStorage.getItem(`samir_portfolio_theme`)||`obsidian`;document.documentElement.setAttribute(`data-theme`,r),i(r),t&&e&&(t.addEventListener(`click`,t=>{t.stopPropagation(),e.classList.toggle(`open`),tl.playClick()}),document.addEventListener(`click`,()=>{e.classList.remove(`open`)})),n.forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-set-theme`);document.documentElement.setAttribute(`data-theme`,n),localStorage.setItem(`samir_portfolio_theme`,n),i(n),e&&e.classList.remove(`open`),tl.playChime()})});function i(e){n.forEach(t=>{t.getAttribute(`data-set-theme`)===e?t.classList.add(`active`):t.classList.remove(`active`)})}}function Dl(){let e=document.getElementById(`soundToggleBtn`),t=document.getElementById(`soundIconOn`),n=document.getElementById(`soundIconOff`);if(!e)return;function r(){let e=tl.isMuted();t&&n&&(t.style.display=e?`none`:`block`,n.style.display=e?`block`:`none`)}r(),e.addEventListener(`click`,()=>{tl.toggleSound(),r()})}function Ol(){let e=document.getElementById(`contactForm`),n=document.getElementById(`contactSubmitBtn`),r=document.getElementById(`submitBtnText`),i=document.getElementById(`formSuccess`),a=document.getElementById(`formError`),o=document.getElementById(`copyEmailBtn`),s=document.getElementById(`copyEmailText`),c=`qureshsamir145@gmail.com`;e&&e.addEventListener(`submit`,async o=>{o.preventDefault();let s=document.getElementById(`senderName`)?.value.trim()||`Valued Contact`,l=document.getElementById(`senderEmail`)?.value.trim(),u=document.getElementById(`senderSubject`)?.value.trim()||`Portfolio Inquiry`,d=document.getElementById(`senderMessage`)?.value.trim();if(!(!l||!d)){n&&(n.disabled=!0),r&&(r.textContent=`Sending Message...`),i&&(i.style.display=`none`),a&&(a.style.display=`none`);try{let n=!1;try{let e=await fetch(`/api/contact/`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:s,email:l,subject:u,message:d})});!e.ok&&e.status===404&&(e=await fetch(`/api/contact`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:s,email:l,subject:u,message:d})})),e.ok&&(n=!0)}catch(e){console.log(`Secure Direct Backend offline, using fallback provider...`,e)}if(!n){let e={name:s,email:l,_replyto:l,_subject:`New Portfolio Message from ${s}: ${u}`,subject:u,message:d,_captcha:`false`,_autoresponse:`Hi ${s},\n\nThank you for reaching out to Samir Qureshi!\n\nYour message regarding "${u}" has been received. Samir will review your note and get back to you directly at ${l} as soon as possible.\n\nBest regards,\nSamir Qureshi\nB.Sc. in CSE (Metropolitan University, Sylhet)\nFull-Stack Web Developer & Cybersecurity Specialist\nPortfolio: https://github.com/samir-60\nDirect Email: ${c}`,_template:`table`};(await fetch(`https://formsubmit.co/ajax/${c}`,{method:`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:JSON.stringify(e)})).ok&&(n=!0)}if(n)tl.playChime(),t({particleCount:120,spread:80,origin:{y:.6},colors:[`#38bdf8`,`#818cf8`,`#c084fc`,`#10b981`]}),i&&(i.style.display=`block`,i.innerHTML=`
            ...
            `),e.reset();else throw Error(`All dispatch methods failed`)}catch(e){console.warn(`Contact form error:`,e),a&&(a.style.display=`block`),window.location.href=`mailto:${c}?subject=${encodeURIComponent(u)}&body=${encodeURIComponent(`From: ${s} (${l})\n\n${d}`)}`}finally{n&&(n.disabled=!1),r&&(r.textContent=`Send Message`)}}}),o&&s&&o.addEventListener(`click`,()=>{tl.playClick(),navigator.clipboard.writeText(c).then(()=>{s.textContent=`✓ Copied: qureshsamir145@gmail.com`,setTimeout(()=>{s.textContent=`Copy qureshsamir145@gmail.com`},3e3)}).catch(()=>{s.textContent=c})})}function kl(){let e=document.querySelectorAll(`.nav-link`),t=document.querySelectorAll(`section[id]`),n=document.getElementById(`backToTopBtn`);window.addEventListener(`scroll`,()=>{let n=window.pageYOffset;t.forEach(t=>{let r=t.offsetHeight,i=t.offsetTop-120,a=t.getAttribute(`id`);n>i&&n<=i+r&&e.forEach(e=>{e.classList.remove(`active`),e.getAttribute(`href`)===`#${a}`&&e.classList.add(`active`)})})}),n&&n.addEventListener(`click`,()=>{tl.playClick(),window.scrollTo({top:0,behavior:`smooth`})})}function Al(){let e=document.getElementById(`liveClockDisplay`);if(!e)return;function t(){e.textContent=`Live (UTC): `+new Date().toUTCString().split(` `).slice(4,5)[0]+` UTC`}t(),setInterval(t,1e3)}