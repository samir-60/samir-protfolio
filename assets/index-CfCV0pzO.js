...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(e,t,n){let r=new Float32Array(Xa),i=new K(0,1,0);return new Li({name:`SphericalGaussianBlur`,defines:{n:Xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Li({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new Li({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mo(),fragmentShader:`
	...
	`}var ho=class extends At{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
...
}`,Wc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new bi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Li({vertexShader:Hc,fragmentShader:Uc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Zr(new wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Gc=class extends rt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,h=typeof XRWebGLBinding<`u`,g=new Wc,_={},v=t.getContextAttributes(),b=null,x=null,S=[],C=[],T=new G,E=null,D=new pa;D.viewport=new Ot;let O=new pa;O.viewport=new Ot;let ee=[D,O],M=new xa,N=null,te=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=S[e];return t===void 0&&(t=new un,S[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=S[e];return t===void 0&&(t=new un,S[e]=t),t.getGripSpace()},this.getHand=function(e){let t=S[e];return t===void 0&&(t=new un,S[e]=t),t.getHandSpace()};function P(e){let t=C.indexOf(e.inputSource);if(t===-1)return;let n=S[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ne(){r.removeEventListener(`select`,P),r.removeEventListener(`selectstart`,P),r.removeEventListener(`selectend`,P),r.removeEventListener(`squeeze`,P),r.removeEventListener(`squeezestart`,P),r.removeEventListener(`squeezeend`,P),r.removeEventListener(`end`,ne),r.removeEventListener(`inputsourceschange`,re);for(let e=0;e<S.length;e++){let t=C[e];t!==null&&(C[e]=null,S[e].disconnect(t))}N=null,te=null,g.reset();for(let e in _)delete _[e];e.setRenderTarget(b),f=null,d=null,u=null,r=null,x=null,ue.stop(),n.isPresenting=!1,e.setPixelRatio(E),e.setSize(T.width,T.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,P),r.addEventListener(`selectstart`,P),r.addEventListener(`selectend`,P),r.addEventListener(`squeeze`,P),r.addEventListener(`squeezestart`,P),r.addEventListener(`squeezeend`,P),r.addEventListener(`end`,ne),r.addEventListener(`inputsourceschange`,re),v.xrCompatible!==!0&&await t.makeXRCompatible(),E=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;v.depth&&(o=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=v.stencil?j:A,a=v.stencil?w:y);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),x=new At(d.textureWidth,d.textureHeight,{format:k,type:m,depthTexture:new vi(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),x=new At(f.framebufferWidth,f.framebufferHeight,{format:k,type:m,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function re(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=C.indexOf(n);r>=0&&(C[r]=null,S[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=C.indexOf(n);if(r===-1){for(let e=0;e<S.length;e++)if(e>=C.length){C.push(n),r=e;break}else if(C[e]===null){C[e]=n,r=e;break}if(r===-1)break}let i=S[r];i&&i.connect(n)}}let ie=new K,ae=new K;function oe(e,t,n){ie.setFromMatrixPosition(t.matrixWorld),ae.setFromMatrixPosition(n.matrixWorld);let r=ie.distanceTo(ae),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function se(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;g.texture!==null&&(g.depthNear>0&&(t=g.depthNear),g.depthFar>0&&(n=g.depthFar)),M.near=O.near=D.near=t,M.far=O.far=D.far=n,(N!==M.near||te!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),N=M.near,te=M.far),M.layers.mask=e.layers.mask|6,D.layers.mask=M.layers.mask&-5,O.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;se(M,i);for(let e=0;e<a.length;e++)se(a[e],i);a.length===2?oe(M,D,O):M.projectionMatrix.copy(D.projectionMatrix),ce(e,M,i)};function ce(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(d!==null||f!==null)return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(M)},this.getCameraTexture=function(e){return _[e]};let F=null;function le(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(x,f.framebuffer),e.setRenderTarget(x));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(x,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(x))}let o=ee[n];o===void 0&&(o=new pa,o.layers.enable(n),o.viewport=new Ot,ee[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&g.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=_[n];e||(e=new bi,_[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<S.length;e++){let t=C[e],n=S[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}F&&F(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let ue=new La;ue.setAnimationLoop(le),this.setAnimationLoop=function(e){F=e},this.dispose=function(){}}},Kc=new Nt,qc=new q;qc.set(-1,0,0,0,1,0,0,0,1);function Jc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ni(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Kc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(qc),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Yc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return H(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?V(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):V(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Xc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Zc=null;function Qc(){return Zc===null&&(Zc=new ei(Xc,16,16,N,x),Zc.name=`DFG_LUT`,Zc.minFilter=d,Zc.magFilter=d,Zc.wrapS=o,Zc.wrapT=o,Zc.generateMipmaps=!1,Zc.needsUpdate=!0),Zc}var $c=class{constructor(e={}){let{canvas:t=Xe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=m}=e;this.isWebGLRenderer=!0;let h;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);h=n.getContextAttributes().alpha}else h=a;let g=f,v=new Set([P,te,M]),b=new Set([m,y,_,w,S,C]),T=new Uint32Array(4),E=new Int32Array(4),D=new K,O=null,k=null,A=[],j=[],ee=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let N=this,ne=!1,re=null,ie=null,ae=null,oe=null;this._outputColorSpace=Be;let se=0,ce=0,F=null,le=-1,ue=null,de=new Ot,fe=new Ot,pe=null,me=new Y(0),he=0,ge=t.width,_e=t.height,ve=1,ye=null,be=null,xe=new Ot(0,0,ge,_e),Se=new Ot(0,0,ge,_e),Ce=!1,we=new ci,Te=!1,Ee=!1,De=new Nt,Oe=new K,ke=new Ot,Ae={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},je=!1;function Me(){return F===null?ve:1}let I=n;function Ne(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,ot,!1),t.addEventListener(`webglcontextrestored`,st,!1),t.addEventListener(`webglcontextcreationerror`,U,!1),I===null){let t=`webgl2`;if(I=Ne(t,e),I===null)throw Ne(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw H(`WebGLRenderer: `+e.message),e}let L,Pe,R,Fe,z,B,Ie,Le,Re,ze,Ve,He,Ue,We,Ge,qe,Je,Ye,Ze,$e,et,nt,rt;function it(){L=new _o(I),L.init(),et=new Vc(I,L),Pe=new Ka(I,L,e,et),R=new zc(I,L),Pe.reversedDepthBuffer&&d&&R.buffers.depth.setReversed(!0),ie=I.createFramebuffer(),ae=I.createFramebuffer(),oe=I.createFramebuffer(),Fe=new bo(I),z=new yc,B=new Bc(I,L,R,z,Pe,et,Fe),Ie=new go(N),Le=new Ra(I),nt=new Wa(I,Le),Re=new vo(I,Le,Fe,nt),ze=new So(I,Re,Le,nt,Fe),Ye=new xo(I,Pe,B),Ge=new qa(z),Ve=new vc(N,Ie,L,Pe,nt,Ge),He=new Jc(N,z),Ue=new Cc,We=new Ac(L),Je=new Ua(N,Ie,R,ze,h,s),qe=new Rc(N,ze,Pe),rt=new Yc(I,Fe,Pe,R),Ze=new Ga(I,L,Fe),$e=new yo(I,L,Fe),Fe.programs=Ve.programs,N.capabilities=Pe,N.extensions=L,N.properties=z,N.renderLists=Ue,N.shadowMap=qe,N.state=R,N.info=Fe}it(),g!==1009&&(ee=new wo(g,t.width,t.height,o,r,i));let at=new Gc(N,I);this.xr=at,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){let e=L.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=L.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ve},this.setPixelRatio=function(e){e!==void 0&&(ve=e,this.setSize(ge,_e,!1))},this.getSize=function(e){return e.set(ge,_e)},this.setSize=function(e,n,r=!0){if(at.isPresenting){V(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ge=e,_e=n,t.width=Math.floor(e*ve),t.height=Math.floor(n*ve),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ee!==null&&ee.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ge*ve,_e*ve).floor()},this.setDrawingBufferSize=function(e,n,r){ge=e,_e=n,ve=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(g===1009){H(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){V(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ee.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(de)},this.getViewport=function(e){return e.copy(xe)},this.setViewport=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),R.viewport(de.copy(xe).multiplyScalar(ve).round())},this.getScissor=function(e){return e.copy(Se)},this.setScissor=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),R.scissor(fe.copy(Se).multiplyScalar(ve).round())},this.getScissorTest=function(){return Ce},this.setScissorTest=function(e){R.setScissorTest(Ce=e)},this.setOpaqueSort=function(e){ye=e},this.setTransparentSort=function(e){be=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(F!==null){let t=F.texture.format;e=v.has(t)}if(e){let e=F.texture.type,t=b.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,I.clearBufferuiv(I.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,I.clearBufferiv(I.COLOR,0,E))}else r|=I.COLOR_BUFFER_BIT}t&&(r|=I.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&I.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),re=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ot,!1),t.removeEventListener(`webglcontextrestored`,st,!1),t.removeEventListener(`webglcontextcreationerror`,U,!1),Je.dispose(),Ue.dispose(),We.dispose(),z.dispose(),Ie.dispose(),ze.dispose(),nt.dispose(),rt.dispose(),Ve.dispose(),at.dispose(),at.removeEventListener(`sessionstart`,ft),at.removeEventListener(`sessionend`,pt),q.stop()};function ot(e){e.preventDefault(),Qe(`WebGLRenderer: Context Lost.`),ne=!0}function st(){Qe(`WebGLRenderer: Context Restored.`),ne=!1;let e=Fe.autoReset,t=qe.enabled,n=qe.autoUpdate,r=qe.needsUpdate,i=qe.type;it(),Fe.autoReset=e,qe.enabled=t,qe.autoUpdate=n,qe.needsUpdate=r,qe.type=i}function U(e){H(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ct(e){let t=e.target;t.removeEventListener(`dispose`,ct),lt(t)}function lt(e){ut(e),z.remove(e)}function ut(e){let t=z.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ae);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ct(e,t,n,r,i);R.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Re.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;nt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Le.get(c),g=$e,g.setIndex(h)),i.isMesh)r.wireframe===!0?(R.setLineWidth(r.wireframeLinewidth*Me()),g.setMode(I.LINES)):g.setMode(I.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),R.setLineWidth(e*Me()),i.isLineSegments?g.setMode(I.LINES):i.isLineLoop?g.setMode(I.LINE_LOOP):g.setMode(I.LINE_STRIP)}else i.isPoints?g.setMode(I.POINTS):i.isSprite&&g.setMode(I.TRIANGLES);if(i.isBatchedMesh){if(L.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Le.get(c).bytesPerElement:1,o=z.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(I,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function W(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,yt(e,t,n),e.side=0,e.needsUpdate=!0,yt(e,t,n),e.side=2):yt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=We.get(n),k.init(t),j.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];W(a,n,e),r.add(a)}else W(t,n,e),r.add(t)}}),k=j.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){z.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}L.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let G=null;function dt(e){G&&G(e)}function ft(){q.stop()}function pt(){q.start()}let q=new La;q.setAnimationLoop(dt),typeof self<`u`&&q.setContext(self),this.setAnimationLoop=function(e){G=e,at.setAnimationLoop(e),e===null?q.stop():q.start()},at.addEventListener(`sessionstart`,ft),at.addEventListener(`sessionend`,pt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){H(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ne===!0)return;re!==null&&re.renderStart(e,t);let n=at.enabled===!0&&at.isPresenting===!0,r=ee!==null&&(F===null||n)&&ee.begin(N,F);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(ee===null||ee.isCompositing()===!1)&&(at.cameraAutoUpdate===!0&&at.updateCamera(t),t=at.getCamera()),e.isScene===!0&&e.onBeforeRender(N,e,t,F),k=We.get(e,j.length),k.init(t),k.state.textureUnits=B.getTextureUnits(),j.push(k),De.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),we.setFromProjectionMatrix(De,Ke,t.reversedDepth),Ee=this.localClippingEnabled,Te=Ge.init(this.clippingPlanes,Ee),O=Ue.get(e,A.length),O.init(),A.push(O),at.enabled===!0&&at.isPresenting===!0){let e=N.xr.getDepthSensingMesh();e!==null&&mt(e,t,-1/0,N.sortObjects)}mt(e,t,0,N.sortObjects),O.finish(),N.sortObjects===!0&&O.sort(ye,be,t.reversedDepth),je=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,je&&Je.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Te===!0&&Ge.beginShadows();let i=k.state.shadowsArray;if(qe.render(i,e,t),Te===!0&&Ge.endShadows(),(r&&ee.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];gt(n,r,e,a)}je&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ht(O,e,n,n.viewport)}}else r.length>0&&gt(n,r,e,t),je&&Je.render(e),ht(O,e,t)}F!==null&&ce===0&&(B.updateMultisampleRenderTarget(F),B.updateRenderTargetMipmap(F)),r&&ee.end(N),e.isScene===!0&&e.onAfterRender(N,e,t),nt.resetDefaultState(),le=-1,ue=null,j.pop(),j.length>0?(k=j[j.length-1],B.setTextureUnits(k.state.textureUnits),Te===!0&&Ge.setGlobalState(N.clippingPlanes,k.state.camera)):k=null,A.pop(),O=A.length>0?A[A.length-1]:null,re!==null&&re.renderEnd()};function mt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||we.intersectsSprite(e)){r&&ke.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De);let t=ze.update(e),i=e.material;i.visible&&O.push(e,t,i,n,ke.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||we.intersectsObject(e))){let t=ze.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),ke.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),ke.copy(e.boundingSphere.center)),ke.applyMatrix4(e.matrixWorld).applyMatrix4(De)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,ke.z,o)}}else i.visible&&O.push(e,t,i,n,ke.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)mt(i[e],t,n,r)}function ht(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Te===!0&&Ge.setGlobalState(N.clippingPlanes,n),r&&R.viewport(de.copy(r)),i.length>0&&_t(i,t,n),a.length>0&&_t(a,t,n),o.length>0&&_t(o,t,n),R.buffers.depth.setTest(!0),R.buffers.depth.setMask(!0),R.buffers.color.setMask(!0),R.setPolygonOffset(!1)}function gt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=L.has(`EXT_color_buffer_half_float`)||L.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new At(1,1,{generateMipmaps:!0,type:e?x:m,minFilter:p,samples:Math.max(4,Pe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:J.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||de;a.setSize(o.z*N.transmissionResolutionScale,o.w*N.transmissionResolutionScale);let s=N.getRenderTarget(),c=N.getActiveCubeFace(),l=N.getActiveMipmapLevel();N.setRenderTarget(a),N.getClearColor(me),he=N.getClearAlpha(),he<1&&N.setClearColor(16777215,.5),N.clear(),je&&Je.render(n);let u=N.toneMapping;N.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Te===!0&&Ge.setGlobalState(N.clippingPlanes,r),_t(e,n,r),B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a),L.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,vt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a))}N.setRenderTarget(s,c,l),N.setClearColor(me,he),d!==void 0&&(r.viewport=d),N.toneMapping=u}function _t(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&vt(o,t,n,s,l,c)}}function vt(e,t,n,r,i,a){e.onBeforeRender(N,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(N,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=2):N.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(N,t,n,r,i,a)}function yt(e,t,n){t.isScene!==!0&&(t=Ae);let r=z.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ie.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ct),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return xt(e,s),d}else s.uniforms=Ve.getUniforms(e),re!==null&&e.isNodeMaterial&&re.build(e,n,s),e.onBeforeCompile(s,N),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ge.uniform),xt(e,s),r.needsLights=Tt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function bt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=js.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function xt(e,t){let n=z.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function St(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ct(e,t,n,r,i){t.isScene!==!0&&(t=Ae),B.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=F===null?N.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:J.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ie.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(h=N.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=z.get(r),y=k.state.lights;if(Te===!0&&(Ee===!0||e!==ue)){let t=e===ue&&r.id===le;Ge.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ge.numPlanes||v.numIntersection!==Ge.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=yt(r,t,i),re&&r.isNodeMaterial&&re.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(R.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==le&&(le=r.id,C=!0),v.needsLights){let e=St(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||ue!==e){R.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(I,`projectionMatrix`,e.projectionMatrix),T.setValue(I,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(I,Oe.setFromMatrixPosition(e.matrixWorld)),Pe.logarithmicDepthBuffer&&T.setValue(I,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(I,`isOrthographic`,e.isOrthographicCamera===!0),ue!==e&&(ue=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(I,`directionalShadowMap`,y.state.directionalShadowMap,B),y.state.spotShadowMap.length>0&&T.setValue(I,`spotShadowMap`,y.state.spotShadowMap,B),y.state.pointShadowMap.length>0&&T.setValue(I,`pointShadowMap`,y.state.pointShadowMap,B)),i.isSkinnedMesh){T.setOptional(I,i,`bindMatrix`),T.setOptional(I,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(I,`boneTexture`,e.boneTexture,B))}i.isBatchedMesh&&(T.setOptional(I,i,`batchingTexture`),T.setValue(I,`batchingTexture`,i._matricesTexture,B),T.setOptional(I,i,`batchingIdTexture`),T.setValue(I,`batchingIdTexture`,i._indirectTexture,B),T.setOptional(I,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(I,`batchingColorTexture`,i._colorsTexture,B));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ye.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(I,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Qc()),C){if(T.setValue(I,`toneMappingExposure`,N.toneMappingExposure),v.needsLights&&wt(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,ve,_e,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}js.upload(I,bt(v),E,B)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(js.upload(I,bt(v),E,B),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(I,`center`,i.center),T.setValue(I,`modelViewMatrix`,i.modelViewMatrix),T.setValue(I,`normalMatrix`,i.normalMatrix),T.setValue(I,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];rt.update(n,x),rt.bind(n,x)}}return x}function wt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Tt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return se},this.getActiveMipmapLevel=function(){return ce},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(e,t,n){let r=z.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),z.get(e.texture).__webglTexture=t,z.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=z.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){F=e,se=t,ce=n;let r=null,i=!1,a=!1;if(e){let o=z.get(e);if(o.__useDefaultFramebuffer!==void 0){R.bindFramebuffer(I.FRAMEBUFFER,o.__webglFramebuffer),de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest,R.viewport(de),R.scissor(fe),R.setScissorTest(pe),le=-1;return}if(o.__webglFramebuffer===void 0)B.setupRenderTarget(e);else if(o.__hasExternalTextures)B.rebindTextures(e,z.get(e.texture).__webglTexture,z.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&z.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);B.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=z.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&B.useMultisampledRTT(e)===!1?z.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest}else de.copy(xe).multiplyScalar(ve).floor(),fe.copy(Se).multiplyScalar(ve).floor(),pe=Ce;if(n!==0&&(r=ie),R.bindFramebuffer(I.FRAMEBUFFER,r)&&R.drawBuffers(e,r),R.viewport(de),R.scissor(fe),R.setScissorTest(pe),i){let r=z.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=z.get(e.textures[t]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=z.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,t.__webglTexture,n)}le=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){R.bindFramebuffer(I.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s),!Pe.textureFormatReadable(c)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Pe.textureTypeReadable(l)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&I.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=F===null?null:z.get(F).__webglFramebuffer;R.bindFramebuffer(I.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){R.bindFramebuffer(I.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s),!Pe.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Pe.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,d),I.bufferData(I.PIXEL_PACK_BUFFER,a.byteLength,I.STREAM_READ),I.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=F===null?null:z.get(F).__webglFramebuffer;R.bindFramebuffer(I.FRAMEBUFFER,f);let p=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await tt(I,p,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,d),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,a),I.deleteBuffer(d),I.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;B.setTexture2D(e,0),I.copyTexSubImage2D(I.TEXTURE_2D,n,0,0,o,s,i,a),R.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(B.setTexture3D(t,0),v=I.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(B.setTexture2DArray(t,0),v=I.TEXTURE_2D_ARRAY):(B.setTexture2D(t,0),v=I.TEXTURE_2D),R.activeTexture(I.TEXTURE0),R.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,t.flipY),R.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),R.pixelStorei(I.UNPACK_ALIGNMENT,t.unpackAlignment);let y=R.getParameter(I.UNPACK_ROW_LENGTH),b=R.getParameter(I.UNPACK_IMAGE_HEIGHT),x=R.getParameter(I.UNPACK_SKIP_PIXELS),S=R.getParameter(I.UNPACK_SKIP_ROWS),C=R.getParameter(I.UNPACK_SKIP_IMAGES);R.pixelStorei(I.UNPACK_ROW_LENGTH,h.width),R.pixelStorei(I.UNPACK_IMAGE_HEIGHT,h.height),R.pixelStorei(I.UNPACK_SKIP_PIXELS,l),R.pixelStorei(I.UNPACK_SKIP_ROWS,u),R.pixelStorei(I.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=z.get(e),r=z.get(t),h=z.get(n.__renderTarget),g=z.get(r.__renderTarget);R.bindFramebuffer(I.READ_FRAMEBUFFER,h.__webglFramebuffer),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,z.get(e).__webglTexture,i,d+n),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,z.get(t).__webglTexture,a,m+n)),I.blitFramebuffer(l,u,o,s,f,p,o,s,I.DEPTH_BUFFER_BIT,I.NEAREST);R.bindFramebuffer(I.READ_FRAMEBUFFER,null),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||z.has(e)){let n=z.get(e),r=z.get(t);R.bindFramebuffer(I.READ_FRAMEBUFFER,ae),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,oe);for(let e=0;e<c;e++)w?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,n.__webglTexture,i),T?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,r.__webglTexture,a),i===0?T?I.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):I.copyTexSubImage2D(v,a,f,p,l,u,o,s):I.blitFramebuffer(l,u,o,s,f,p,o,s,I.COLOR_BUFFER_BIT,I.NEAREST);R.bindFramebuffer(I.READ_FRAMEBUFFER,null),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?I.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h);R.pixelStorei(I.UNPACK_ROW_LENGTH,y),R.pixelStorei(I.UNPACK_IMAGE_HEIGHT,b),R.pixelStorei(I.UNPACK_SKIP_PIXELS,x),R.pixelStorei(I.UNPACK_SKIP_ROWS,S),R.pixelStorei(I.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&I.generateMipmap(v),R.unbindTexture()},this.initRenderTarget=function(e){z.get(e).__webglFramebuffer===void 0&&B.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?B.setTextureCube(e,0):e.isData3DTexture?B.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?B.setTexture2DArray(e,0):B.setTexture2D(e,0),R.unbindTexture()},this.resetState=function(){se=0,ce=0,F=null,R.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ke}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=J._getDrawingBufferColorSpace(e),t.unpackColorSpace=J._getUnpackColorSpace()}},el=class{constructor(e){this.container=document.getElementById(e),this.container&&(this.scene=null,this.camera=null,this.renderer=null,this.mesh=null,this.sculpture=null,this.corePoly=null,this.rings=[],this.ambientParticles=null,this.mouseX=0,this.mouseY=0,this.targetMouseX=0,this.targetMouseY=0,this.isDragging=!1,this.previousMousePosition={x:0,y:0},this.manualRotationX=0,this.manualRotationY=0,this.clock=new Pa,this.animationFrameId=null,this.init())}init(){let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.scene=new gn,this.camera=new pa(50,e/t,.1,100),this.camera.position.set(0,1.2,13),this.renderer=new $c({antialias:!0,alpha:!0,powerPreference:`high-performance`}),this.renderer.setSize(e,t),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.container.appendChild(this.renderer.domElement);let n=new _a(16777215,.8);this.scene.add(n);let r=new ha(3718648,2.5,30);r.position.set(8,6,8),this.scene.add(r);let i=new ha(8490232,2,30);i.position.set(-8,-4,6),this.scene.add(i),this.createOrganicFluidMesh(),this.createParametricSculpture(),this.createAmbientDust(),this.setupEvents(),this.animate()}createOrganicFluidMesh(){let e=new wi(36,24,72,48);e.attributes.position.count,e.userData={originalPositions:new Float32Array(e.attributes.position.array)};let t=new zr({color:5195493,wireframe:!0,transparent:!0,opacity:.15});this.mesh=new Zr(e,t),this.mesh.rotation.x=-Math.PI/2.7,this.mesh.position.set(0,-3.8,-1),this.scene.add(this.mesh)}createParametricSculpture(){this.sculptureGroup=new cn,this.sculptureGroup.position.set(0,1,0);let e=new Oi(2.6,.45,160,32,2,3),t=new zr({color:8490232,wireframe:!0,transparent:!0,opacity:.32});this.sculpture=new Zr(e,t),this.sculptureGroup.add(this.sculpture);let n=new Ci(1.3,1),r=new zr({color:3718648,wireframe:!0,transparent:!0,opacity:.5});this.corePoly=new Zr(n,r),this.sculptureGroup.add(this.corePoly),[{radius:3.8,color:3718648,rotX:Math.PI/3,rotY:0},{radius:4.2,color:12616956,rotX:-Math.PI/4,rotY:Math.PI/6}].forEach(e=>{let t=new Zr(new Ti(e.radius,e.radius+.04,80),new zr({color:e.color,transparent:!0,opacity:.28,side:2}));t.rotation.x=e.rotX,t.rotation.y=e.rotY,this.rings.push(t),this.sculptureGroup.add(t)}),this.scene.add(this.sculptureGroup)}createAmbientDust(){let e=new lr,t=new Float32Array(660);for(let e=0;e<660;e+=3)t[e]=(Math.random()-.5)*40,t[e+1]=(Math.random()-.5)*26,t[e+2]=(Math.random()-.5)*24;e.setAttribute(`position`,new Yn(t,3));let n=new li({color:14739455,size:.18,transparent:!0,opacity:.6});this.ambientParticles=new mi(e,n),this.scene.add(this.ambientParticles)}setupEvents(){window.addEventListener(`mousemove`,e=>{this.targetMouseX=(e.clientX/window.innerWidth-.5)*2,this.targetMouseY=(e.clientY/window.innerHeight-.5)*2}),this.renderer.domElement.addEventListener(`mousedown`,e=>{this.isDragging=!0,this.previousMousePosition={x:e.clientX,y:e.clientY}}),window.addEventListener(`mouseup`,()=>{this.isDragging=!1}),window.addEventListener(`mousemove`,e=>{if(!this.isDragging)return;let t=e.clientX-this.previousMousePosition.x,n=e.clientY-this.previousMousePosition.y;this.manualRotationY+=t*.005,this.manualRotationX+=n*.005,this.previousMousePosition={x:e.clientX,y:e.clientY}}),window.addEventListener(`resize`,()=>{if(!this.container||!this.renderer||!this.camera)return;let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t)}),window.addEventListener(`scroll`,()=>{let e=window.scrollY;this.camera&&(this.camera.position.y=1.2-e*.0025)})}animate(){this.animationFrameId=requestAnimationFrame(()=>this.animate());let e=this.clock.getElapsedTime();if(this.mouseX+=(this.targetMouseX-this.mouseX)*.05,this.mouseY+=(this.targetMouseY-this.mouseY)*.05,this.sculptureGroup){this.sculptureGroup.rotation.y=e*.22+this.mouseX*.4+this.manualRotationY,this.sculptureGroup.rotation.x=Math.sin(e*.18)*.15-this.mouseY*.3+this.manualRotationX,this.sculptureGroup.rotation.z=Math.cos(e*.15)*.08;let t=1+Math.sin(e*1.5)*.03;this.sculptureGroup.scale.set(t,t,t)}if(this.sculpture&&(this.sculpture.rotation.y=-e*.15),this.corePoly&&(this.corePoly.rotation.x=e*.4,this.corePoly.rotation.y=e*.5),this.rings.forEach((t,n)=>{t.rotation.z=e*(.2+n*.1)*(n%2==0?1:-1)}),this.mesh&&this.mesh.geometry.userData.originalPositions){let t=this.mesh.geometry.attributes.position.array,n=this.mesh.geometry.userData.originalPositions;for(let r=0;r<t.length;r+=3){let i=n[r],a=n[r+1],o=Math.sin(i*.25+e*1.2)*Math.cos(a*.3+e*.8)*1.1,s=Math.hypot(i-this.mouseX*10,a-this.mouseY*6),c=Math.sin(s*.5-e*2)*.35*Math.exp(-s*.1);t[r+2]=n[r+2]+o+c}this.mesh.geometry.attributes.position.needsUpdate=!0}this.ambientParticles&&(this.ambientParticles.rotation.y=e*.04,this.ambientParticles.rotation.x=e*.02),this.renderer.render(this.scene,this.camera)}destroy(){this.animationFrameId&&cancelAnimationFrame(this.animationFrameId),this.renderer&&this.renderer.domElement&&(this.renderer.domElement.remove(),this.renderer.dispose())}},tl=class{constructor(e){this.container=document.getElementById(e),this.container&&(this.scene=null,this.camera=null,this.renderer=null,this.group=null,this.tags=[],this.isDragging=!1,this.prevMousePos={x:0,y:0},this.rotationVelocity={x:.002,y:.003},this.init())}init(){let e=this.container.clientWidth||500,t=this.container.clientHeight||450;this.scene=new gn,this.camera=new pa(50,e/t,.1,1e3),this.camera.position.z=24,this.renderer=new $c({antialias:!0,alpha:!0,powerPreference:`high-performance`}),this.renderer.setSize(e,t),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.container.appendChild(this.renderer.domElement),this.group=new cn,this.scene.add(this.group),this.createOrbitalRings(),this.createSkillSprites(),this.setupInteractivity(),this.animate()}createOrbitalRings(){[{radius:6.5,color:3718648,rotX:Math.PI/4,rotY:0},{radius:8.5,color:8490232,rotX:-Math.PI/3,rotY:Math.PI/6},{radius:10.2,color:12616956,rotX:Math.PI/6,rotY:-Math.PI/4}].forEach(({radius:e,color:t,rotX:n,rotY:r})=>{let i=new Zr(new Di(e,.02,16,100),new zr({color:t,transparent:!0,opacity:.25,blending:2}));i.rotation.set(n,r,0),this.group.add(i)});let e=new Ei(1.2,16,16),t=new zr({color:3718648,wireframe:!0,transparent:!0,opacity:.4});this.group.add(new Zr(e,t))}createSkillSprites(){let e=r.cloudSphereTags,t=e.length,n=9.5,i=Math.PI*(3-Math.sqrt(5));e.forEach((e,r)=>{let a=1-r/(t-1)*2,o=Math.sqrt(1-a*a),s=i*r,c=Math.cos(s)*o,l=Math.sin(s)*o,u=this.makeTextSprite(e.text,e.color,e.weight);u.position.set(c*n,a*n,l*n),u.userData={originalScale:u.scale.clone()},this.tags.push(u),this.group.add(u)})}makeTextSprite(e,t,n=1){let r=document.createElement(`canvas`);r.width=256,r.height=64;let i=r.getContext(`2d`);i.fillStyle=`rgba(15, 23, 42, 0.75)`,i.strokeStyle=t||`#38bdf8`,i.lineWidth=2,i.beginPath(),i.moveTo(16,6),i.lineTo(240,6),i.quadraticCurveTo(256,6,256,22),i.lineTo(256,42),i.quadraticCurveTo(256,58,240,58),i.lineTo(16,58),i.quadraticCurveTo(0,58,0,42),i.lineTo(0,22),i.quadraticCurveTo(0,6,16,6),i.closePath(),i.fill(),i.stroke(),i.font=`bold 22px "Plus Jakarta Sans", "Inter", sans-serif`,i.fillStyle=`#ffffff`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e,128,32);let a=new _i(r);a.minFilter=d;let o=new kr(new hr({map:a,transparent:!0,opacity:.95,depthTest:!1}));return o.scale.set(4.2*n,1.05*n,1),o}setupInteractivity(){let e=this.renderer.domElement;e.addEventListener(`mousedown`,e=>{this.isDragging=!0,this.prevMousePos={x:e.clientX,y:e.clientY}}),window.addEventListener(`mouseup`,()=>{this.isDragging=!1}),window.addEventListener(`mousemove`,e=>{if(this.isDragging){let t=e.clientX-this.prevMousePos.x,n=e.clientY-this.prevMousePos.y;this.rotationVelocity.y=t*.005,this.rotationVelocity.x=n*.005,this.group.rotation.y+=this.rotationVelocity.y,this.group.rotation.x+=this.rotationVelocity.x,this.prevMousePos={x:e.clientX,y:e.clientY}}}),e.addEventListener(`touchstart`,e=>{e.touches.length===1&&(this.isDragging=!0,this.prevMousePos={x:e.touches[0].clientX,y:e.touches[0].clientY})},{passive:!0}),window.addEventListener(`touchend`,()=>{this.isDragging=!1}),window.addEventListener(`touchmove`,e=>{if(this.isDragging&&e.touches.length===1){let t=e.touches[0].clientX-this.prevMousePos.x,n=e.touches[0].clientY-this.prevMousePos.y;this.rotationVelocity.y=t*.005,this.rotationVelocity.x=n*.005,this.group.rotation.y+=this.rotationVelocity.y,this.group.rotation.x+=this.rotationVelocity.x,this.prevMousePos={x:e.touches[0].clientX,y:e.touches[0].clientY}}},{passive:!0}),window.addEventListener(`resize`,()=>{if(!this.container||!this.renderer||!this.camera)return;let e=this.container.clientWidth||500,t=this.container.clientHeight||450;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t)})}animate(){requestAnimationFrame(()=>this.animate()),this.isDragging||(this.rotationVelocity.y*=.96,this.rotationVelocity.x*=.96,this.group.rotation.y+=.003+this.rotationVelocity.y,this.group.rotation.x+=.0015+this.rotationVelocity.x),this.tags.forEach(e=>{let t=new K;e.getWorldPosition(t);let n=this.camera.position.distanceTo(t),r=Math.max(.7,Math.min(1.25,24/n));e.scale.x=e.userData.originalScale.x*r,e.scale.y=e.userData.originalScale.y*r,e.material.opacity=Math.max(.4,Math.min(1,1.3-(n-14)/18))}),this.renderer.render(this.scene,this.camera)}},$=new class{constructor(){this.audioCtx=null,this.muted=localStorage.getItem(`samir_portfolio_sound`)===`false`,this.initialized=!1}init(){if(!this.initialized&&typeof window<`u`){let e=window.AudioContext||window.webkitAudioContext;e&&(this.audioCtx=new e,this.initialized=!0)}}ensureContext(){this.audioCtx||this.init(),this.audioCtx&&this.audioCtx.state===`suspended`&&this.audioCtx.resume()}toggleSound(){return this.muted=!this.muted,localStorage.setItem(`samir_portfolio_sound`,(!this.muted).toString()),this.muted||this.playChime(),!this.muted}isMuted(){return this.muted}playClick(){if(!this.muted)try{if(this.ensureContext(),!this.audioCtx)return;let e=this.audioCtx.createOscillator(),t=this.audioCtx.createGain();e.type=`sine`,e.frequency.setValueAtTime(800,this.audioCtx.currentTime),e.frequency.exponentialRampToValueAtTime(300,this.audioCtx.currentTime+.05),t.gain.setValueAtTime(.06,this.audioCtx.currentTime),t.gain.exponentialRampToValueAtTime(.001,this.audioCtx.currentTime+.05),e.connect(t),t.connect(this.audioCtx.destination),e.start(),e.stop(this.audioCtx.currentTime+.05)}catch{}}playHover(){if(!this.muted)try{if(this.ensureContext(),!this.audioCtx)return;let e=this.audioCtx.createOscillator(),t=this.audioCtx.createGain();e.type=`triangle`,e.frequency.setValueAtTime(520,this.audioCtx.currentTime),e.frequency.linearRampToValueAtTime(640,this.audioCtx.currentTime+.04),t.gain.setValueAtTime(.015,this.audioCtx.currentTime),t.gain.exponentialRampToValueAtTime(1e-4,this.audioCtx.currentTime+.04),e.connect(t),t.connect(this.audioCtx.destination),e.start(),e.stop(this.audioCtx.currentTime+.04)}catch{}}playModalOpen(){if(!this.muted)try{if(this.ensureContext(),!this.audioCtx)return;let e=this.audioCtx.createOscillator(),t=this.audioCtx.createGain();e.type=`sine`,e.frequency.setValueAtTime(240,this.audioCtx.currentTime),e.frequency.exponentialRampToValueAtTime(580,this.audioCtx.currentTime+.15),t.gain.setValueAtTime(.08,this.audioCtx.currentTime),t.gain.exponentialRampToValueAtTime(.001,this.audioCtx.currentTime+.18),e.connect(t),t.connect(this.audioCtx.destination),e.start(),e.stop(this.audioCtx.currentTime+.18)}catch{}}playChime(){if(!this.muted)try{if(this.ensureContext(),!this.audioCtx)return;[523.25,659.25,783.99,1046.5].forEach((e,t)=>{let n=this.audioCtx.createOscillator(),r=this.audioCtx.createGain();n.type=`sine`,n.frequency.setValueAtTime(e,this.audioCtx.currentTime+t*.06),r.gain.setValueAtTime(.05,this.audioCtx.currentTime+t*.06),r.gain.exponentialRampToValueAtTime(1e-4,this.audioCtx.currentTime+t*.06+.35),n.connect(r),r.connect(this.audioCtx.destination),n.start(this.audioCtx.currentTime+t*.06),n.stop(this.audioCtx.currentTime+t*.06+.35)})}catch{}}},nl=class{constructor(e,t){this.body=document.getElementById(e),this.input=document.getElementById(t),this.history=[],this.historyIndex=-1,this.commandList=[`help`,`about`,`skills`,`projects`,`experience`,`contact`,`hire`,`theme`,`matrix`,`resume`,`quote`,`sudo`,`clear`],this.input&&this.body&&this.init()}init(){this.input.addEventListener(`keydown`,e=>this.handleKeyDown(e));let e=this.body.closest(`.terminal-window`);e&&e.addEventListener(`click`,()=>{this.input.focus()}),this.appendOutput([`<span class="term-cyan">⚡ Welcome to Samir Qureshi's Interactive CLI Shell (v2.4.0)</span>`,`<span class="term-muted">Type <span class="term-yellow">help</span> to view available commands or try <span class="term-green">projects</span>, <span class="term-cyan">about</span>, or <span class="term-purple">matrix</span>.</span>`,``])}handleKeyDown(e){if(e.key===`Enter`){let e=this.input.value.trim();if(!e)return;$.playClick(),this.history.push(e),this.historyIndex=this.history.length,this.appendCommand(e),this.executeCommand(e.toLowerCase()),this.input.value=``,this.scrollToBottom()}else if(e.key===`ArrowUp`)e.preventDefault(),this.historyIndex>0&&(this.historyIndex--,this.input.value=this.history[this.historyIndex]||``);else if(e.key===`ArrowDown`)e.preventDefault(),this.historyIndex<this.history.length-1?(this.historyIndex++,this.input.value=this.history[this.historyIndex]||``):(this.historyIndex=this.history.length,this.input.value=``);else if(e.key===`Tab`){e.preventDefault();let t=this.input.value.trim().toLowerCase();if(!t)return;let n=this.commandList.find(e=>e.startsWith(t));n&&(this.input.value=n)}}appendCommand(e){let t=document.createElement(`div`);t.className=`terminal-line term-prompt-line`,t.innerHTML=`<span class="term-prompt">samir@innovator:~$</span> <span class="term-cmd-text">${this.escapeHTML(e)}</span>`,this.body.appendChild(t)}appendOutput(e){let t=document.createElement(`div`);t.className=`terminal-output`,t.innerHTML=e.join(`<br>`),this.body.appendChild(t)}scrollToBottom(){this.body.scrollTop=this.body.scrollHeight}escapeHTML(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e]||e)}executeCommand(e){let t=e.split(` `),n=t[0],r=t[1];switch(n){case`help`:this.appendOutput([`<span class="term-header">AVAILABLE COMMANDS:</span>`,`  <span class="term-yellow">about</span>        - Get to know Samir Qureshi & his engineering philosophy`,`  <span class="term-yellow">skills</span>       - Inspect technical stack & proficiency breakdown`,`  <span class="term-yellow">projects</span>     - Browse flagship projects including BiblioDrop`,`  <span class="term-yellow">experience</span>   - View career timeline & milestones`,`  <span class="term-yellow">contact</span>      - Direct communication channels (LinkedIn, GitHub, Email)`,`  <span class="term-yellow">hire</span>         - Why hire Samir? Key value proposition`,`  <span class="term-yellow">theme [name]</span> - Change UI theme: <span class="term-cyan">obsidian</span>, <span class="term-green">emerald</span>, <span class="term-yellow">solar</span>`,`  <span class="term-yellow">matrix</span>       - Trigger digital cyber rain visualizer`,`  <span class="term-yellow">resume</span>       - Open the official printable resume view`,`  <span class="term-yellow">quote</span>        - Inspiring thought on architecture & design`,`  <span class="term-yellow">clear</span>        - Clean up the terminal display`]);break;case`about`:this.appendOutput([`<span class="term-header">ABOUT SAMIR QURESHI:</span>`,`  <span class="term-cyan">Name:</span>        Samir Qureshi`,`  <span class="term-cyan">Education:</span>   B.Sc. in Computer Science &amp; Engineering (2025 — 2029)`,`  <span class="term-cyan">University:</span>  Metropolitan University, Sylhet`,`  <span class="term-cyan">Roles:</span>       Full-Stack Web Developer • Cybersecurity Specialist • Businessman &amp; Entrepreneur • CSE Researcher`,`  <span class="term-cyan">Ventures:</span>    Founder @ Softyx Clothing (softyx.shop), Profix &amp; Shine UK (profixandshine.co.uk)`,`  <span class="term-cyan">Mission:</span>     Merging rigorous CSE research, cybersecurity defense, and full-stack software development into high-impact businesses.`,`  <span class="term-muted">"Bridging Computer Science Research, Cybersecurity &amp; Real-World Entrepreneurship."</span>`]);break;case`skills`:this.appendOutput([`<span class="term-header">TECHNICAL SKILL & DOMAIN MASTERY:</span>`,`  <span class="term-cyan">CSE Core:</span>      DSA, Algorithms, OOP, DBMS, Computer Networks, Operating Systems`,`  <span class="term-green">Web Dev:</span>       TypeScript, JavaScript (ES6+), React/Next.js, Node.js, Express, Three.js 3D`,`  <span class="term-purple">Cybersecurity:</span> E-Commerce Fraud Detection, OWASP, Authentication, Vulnerability Audit`,`  <span class="term-yellow">Business &amp; Res:</span> Product Strategy, Brand Monetization, AI Data Modeling (FieldForesight)`]);break;case`projects`:this.appendOutput([`<span class="term-header">FEATURED GITHUB REPOSITORIES & LIVE PLATFORMS:</span>`,`  1. <span class="term-cyan">Softyx Clothing</span> (Live on softyx.shop) - E-commerce platform with live virtual try-on & body scanner`,`  2. <span class="term-green">Profix &amp; Shine UK</span> (Live on profixandshine.co.uk) - UK cleaning services commercial web platform`,`  3. <span class="term-purple">BiblioDrop</span> (GitHub) - Community literature & book exchange platform`,`  4. <span class="term-yellow">Softyx Fraud Checker</span> (GitHub) - Transaction risk scoring & e-commerce fraud detection`,`  5. <span class="term-pink">StudySync</span> (GitHub) - Synchronized study & academic collaboration hub`,`  <span class="term-muted">Browse full code on GitHub: <a href="https://github.com/samir-60" target="_blank" class="term-link">github.com/samir-60</a></span>`]);break;case`experience`:this.appendOutput([`<span class="term-header">CAREER TIMELINE:</span>`,`  <span class="term-cyan">2023 - Present:</span> Full-Stack Engineer & Creative Technologist (Open Source / BiblioDrop)`,`  <span class="term-purple">2022 - 2024:</span>    Business Technologist & Solution Architect`,`  <span class="term-yellow">2021 - 2023:</span>    Software Developer & Technical Explorer`]);break;case`contact`:this.appendOutput([`<span class="term-header">GET IN TOUCH:</span>`,`  <span class="term-green">WhatsApp:</span> <a href="https://wa.me/8801725198663" target="_blank" class="term-link">+8801725198663</a>`,`  <span class="term-cyan">Email:</span>    <a href="mailto:qureshsamir145@gmail.com" class="term-link">qureshsamir145@gmail.com</a>`,`  <span class="term-cyan">LinkedIn:</span> <a href="https://www.linkedin.com/in/samir-qureshi-b13b27261/" target="_blank" class="term-link">https://www.linkedin.com/in/samir-qureshi-b13b27261/</a>`,`  <span class="term-green">GitHub:</span>   <a href="https://github.com/samir-60" target="_blank" class="term-link">https://github.com/samir-60</a>`,`  <span class="term-yellow">Status:</span>   [Available] Open to full-time roles, contracts, &amp; high-impact projects`]);break;case`hire`:this.appendOutput([`<span class="term-header">WHY WORK WITH SAMIR QURESHI?</span>`,`  [+] <span class="term-green">Hybrid Mastery:</span> Rigorous computer science fundamentals + commercial business acumen.`,`  [+] <span class="term-green">Performance Obsession:</span> Sub-second API responses and locked 60 FPS 3D spatial execution.`,`  [+] <span class="term-green">Total Ownership:</span> Clear communication, proactive delivery, and reliable clean code.`,`  <span class="term-muted">Ready to discuss? Scroll down to the contact section or write directly to qureshsamir145@gmail.com</span>`]);break;case`theme`:r?[`obsidian`,`emerald`,`solar`].includes(r)?(document.documentElement.setAttribute(`data-theme`,r),localStorage.setItem(`samir_portfolio_theme`,r),$.playChime(),this.appendOutput([`<span class="term-green">✔ Switched theme to: <strong>${r}</strong></span>`])):this.appendOutput([`<span class="term-red">Unknown theme '${r}'. Choose obsidian, emerald, or solar.</span>`]):this.appendOutput([`Usage: <span class="term-yellow">theme [obsidian | emerald | solar]</span>`]);break;case`matrix`:this.runMatrixEffect();break;case`resume`:let t=document.getElementById(`openResumeBtn`);t?(t.click(),this.appendOutput([`<span class="term-green">Opening official resume modal...</span>`])):this.appendOutput([`<span class="term-yellow">Resume viewer loaded in modal.</span>`]);break;case`quote`:let n=[`"Simplicity is prerequisite for reliability." — Edsger W. Dijkstra`,`"Good code is its own best documentation." — Steve McConnell`,`"First, solve the problem. Then, write the code." — John Johnson`,`"Make it work, make it right, make it fast." — Kent Beck`],i=n[Math.floor(Math.random()*n.length)];this.appendOutput([`<span class="term-purple">${i}</span>`]);break;case`sudo`:this.appendOutput([`<span class="term-red">Permission denied: You are a guest in Samir's digital universe. (Nice try though! 🚀)</span>`]);break;case`clear`:this.body.innerHTML=``;break;default:this.appendOutput([`<span class="term-red">Command not recognized: '${e}'.</span> Type <span class="term-yellow">help</span> for a list of valid commands.`])}}runMatrixEffect(){this.appendOutput([`<span class="term-green">Initializing Matrix Stream...</span>`]);let e=0,t=setInterval(()=>{let n=``;for(let e=0;e<40;e++)n+=String.fromCharCode(33+Math.floor(Math.random()*93));let r=document.createElement(`div`);if(r.className=`term-matrix-line`,r.innerText=n,this.body.appendChild(r),this.scrollToBottom(),e++,e>12){clearInterval(t);let e=document.createElement(`div`);e.innerHTML=`<span class="term-cyan">Matrix stream decoupled. Reality restored.</span>`,this.body.appendChild(e),this.scrollToBottom()}},80)}},rl=class{constructor(e,t,n){this.modal=document.getElementById(e),this.backdrop=document.getElementById(t),this.content=document.getElementById(n),this.closeBtn=this.modal?this.modal.querySelector(`.modal-close-btn`):null,this.modal&&this.init()}init(){this.closeBtn&&this.closeBtn.addEventListener(`click`,()=>this.close()),this.backdrop&&this.backdrop.addEventListener(`click`,()=>this.close()),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.isOpen()&&this.close()})}isOpen(){return this.modal&&this.modal.classList.contains(`active`)}open(e){!this.modal||!this.content||($.playModalOpen(),this.content.innerHTML=`
      <div class="project-modal-header">
        <div class="project-badge" style="background: ${e.color}22; color: ${e.color}; border: 1px solid ${e.color}55;">
          ${e.badge||`Featured Innovation`}
        </div>
        <h2 class="project-modal-title">${e.title}</h2>
        <p class="project-modal-subtitle">${e.subtitle}</p>
      </div>

      <div class="project-modal-hero-img-wrap">
        <img src="${e.image}" alt="${e.title}" class="project-modal-img" loading="lazy" />
      ...
      <div class="project-modal-body">
        ...
        <div class="project-modal-section">
          ...
          <ul class="modal-highlights-list">
            ${e.highlights.map(t=>`<li><span class="bullet" style="color: ${e.color}">▹</span> ${t}</li>`).join(``)}
          </ul>
        </div>
        ...
        <div class="project-modal-section">
          ...
          <div class="modal-tags-wrap">
            ${e.tags.map(e=>`<span class="tech-tag">${e}</span>`).join(``)}
          </div>
        </div>

        <div class="project-modal-stats-grid">
          ${Object.entries(e.stats||{}).map(([t,n])=>`
            <div class="modal-stat-box">
              <span class="stat-key">${t.toUpperCase()}</span>
              <span class="stat-val" style="color: ${e.color}">${n}</span>
            </div>
          `).join(``)}
        </div>

        <div class="project-modal-actions">
          <a href="${e.githubUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-secondary modal-action-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
            View Repository
          </a>
          <a href="${e.liveUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-primary modal-action-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
            Explore Live Platform
          </a>
        </div>
      </div>
    `,document.body.classList.add(`modal-locked`),this.modal.classList.add(`active`))}close(){this.modal&&($.playClick(),this.modal.classList.remove(`active`),document.body.classList.remove(`modal-locked`))}},il=class{constructor(e,t,n){this.modal=document.getElementById(e),this.backdrop=document.getElementById(t),this.triggerBtn=document.getElementById(n),this.closeBtn=this.modal?this.modal.querySelector(`.modal-close-btn`):null,this.printBtn=this.modal?this.modal.querySelector(`#printResumeBtn`):null,this.modal&&this.init()}init(){this.triggerBtn&&this.triggerBtn.addEventListener(`click`,e=>{e.preventDefault(),this.open()}),this.closeBtn&&this.closeBtn.addEventListener(`click`,()=>this.close()),this.backdrop&&this.backdrop.addEventListener(`click`,()=>this.close()),this.printBtn&&this.printBtn.addEventListener(`click`,()=>{$.playClick(),window.print()}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.isOpen()&&this.close()})}isOpen(){return this.modal&&this.modal.classList.contains(`active`)}open(){this.modal&&($.playModalOpen(),document.body.classList.add(`modal-locked`),this.modal.classList.add(`active`))}close(){this.modal&&($.playClick(),this.modal.classList.remove(`active`),document.body.classList.remove(`modal-locked`))}},al=class{constructor(){this.initInteractiveAudio(),this.init3DTilt(),this.init3DTitle()}init3DTitle(){let e=document.getElementById(`heroTitleWrap`),t=document.getElementById(`heroSubtitle3D`);window.addEventListener(`mousemove`,n=>{let r=(n.clientX/window.innerWidth-.5)*2,i=(n.clientY/window.innerHeight-.5)*2;if(e){let t=r*14,n=-i*12;e.style.transform=`perspective(1200px) rotateX(${n.toFixed(2)}deg) rotateY(${t.toFixed(2)}deg) translateZ(12px)`}if(t){let e=r*9,n=-i*8;t.style.transform=`perspective(1200px) rotateX(${n.toFixed(2)}deg) rotateY(${e.toFixed(2)}deg) translateZ(8px)`}})}initInteractiveAudio(){document.querySelectorAll(`a, button, input, textarea, .interactive-card, .skill-pill, .filter-btn`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{$.playHover()}),e.addEventListener(`click`,()=>{$.playClick()})})}init3DTilt(){document.querySelectorAll(`.tilt-card`).forEach(e=>{e.addEventListener(`mousemove`,t=>{let n=e.getBoundingClientRect(),r=t.clientX-n.left,i=t.clientY-n.top,a=n.width/2,o=n.height/2,s=(i-o)/o*-10,c=(r-a)/a*10;e.style.transform=`perspective(1000px) rotateX(${s.toFixed(2)}deg) rotateY(${c.toFixed(2)}deg) translateZ(12px)`;let l=e.querySelector(`.card-glare`);if(l){let e=r/n.width*100,t=i/n.height*100;l.style.background=`radial-gradient(circle at ${e}% ${t}%, rgba(255,255,255,0.18), transparent 60%)`}}),e.addEventListener(`mouseleave`,()=>{e.style.transform=`perspective(1000px) rotateX(0deg) rotateY(0deg) translateZ(0px)`;let t=e.querySelector(`.card-glare`);t&&(t.style.background=`transparent`)})})}},ol=class{constructor(e){this.container=document.getElementById(e),this.container&&(this.currentSlide=0,this.totalSlides=3,this.autoPlayInterval=null,this.isPaused=!1,this.touchStartX=0,this.touchEndX=0,this.slidesData=[{id:`softyx`,status:`LIVE PRODUCTION STORE`,domain:`softyx.shop`,domainUrl:`https://softyx.shop`,githubUrl:`https://github.com/samir-60/Softyx-Clothing`,title:`SOFTYX CLOTHING`,tagline:`Flagship E-Commerce Fashion Platform & Virtual Try-On Engine`,description:`Engineered for high-volume commercial scale in Bangladesh with real-time body dimension scanning, interactive 3D virtual fitting drape geometry, sub-second catalog search, and secure payment checkout.`,telemetry:[{label:`ARCHITECTURE`,value:`TypeScript / React / Node`},{label:`CAPABILITIES`,value:`3D Virtual Try-On • Body Scanner`},{label:`AVAILABILITY`,value:`Live 24/7 Global Production`},{label:`PERFORMANCE`,value:`Sub-second Load Time`}],tags:[`softyx.shop`,`Virtual Try-On`,`Body Scanner`,`TypeScript`,`E-Commerce`,`Active Platform`]},{id:`profix`,status:`UK LIVE COMMERCIAL WEB`,domain:`profixandshine.co.uk`,domainUrl:`https://profixandshine.co.uk`,githubUrl:`https://github.com/samir-60/Profix-shine-uk`,title:`PROFIX & SHINE UK`,tagline:`Commercial & Residential Cleaning Services Platform Operating in the UK`,description:`Bespoke web infrastructure designed for the United Kingdom cleaning sector, featuring instant automated quotation calculators, customer booking funnels, and mobile-first 99+ Google Lighthouse optimization.`,telemetry:[{label:`MARKET REGION`,value:`United Kingdom (UK)`},{label:`WORKFLOWS`,value:`Instant Quote Engine • Booking Funnel`},{label:`LIGHTHOUSE`,value:`99+ Performance & SEO Score`},{label:`CLIENT CONVERSION`,value:`Optimized Mobile UI/UX`}],tags:[`profixandshine.co.uk`,`United Kingdom`,`Instant Quotation`,`Booking System`,`99+ Lighthouse`,`Commercial`]},{id:`fraud-radar`,status:`CYBER DEFENSE CORE`,domain:`github.com/samir-60`,domainUrl:`https://github.com/samir-60/Softyx-Clothing`,githubUrl:`https://github.com/samir-60/Softyx-Clothing`,title:`SOFTYX FRAUD RADAR`,tagline:`Heuristic E-Commerce Risk Scoring & Velocity Defense Algorithm`,description:`Handcrafted cybersecurity analysis engine engineered to analyze customer checkout telemetry, IP velocity patterns, device fingerprinting, and risk scoring to prevent merchant chargebacks.`,telemetry:[{label:`CORE PROTOCOL`,value:`Heuristic Velocity Math`},{label:`DETECTION SPEED`,value:`12ms Real-time Decisioning`},{label:`SECURITY DOMAIN`,value:`Cybersecurity & Anti-Fraud`},{label:`MERCHANT SAFETY`,value:`Chargeback & Bot Shield`}],tags:[`Cybersecurity`,`Fraud Scoring`,`Risk Analysis`,`TypeScript`,`Heuristic Defense`]}],this.render(),this.bindEvents(),this.startAutoPlay())}render(){this.container.innerHTML=`
      <div class="masculine-slider-card">
        ...
        <div class="masculine-slider-viewport" id="sliderViewport">
          <div class="masculine-slider-track" id="sliderTrack">
            ${this.slidesData.map((e,t)=>this.renderSlideHTML(e,t)).join(``)}
          </div>
        </div>

        <!-- Bottom Tabs / Segment Pagination -->
        <div class="masculine-slider-tabs">
          ${this.slidesData.map((e,t)=>`
            <button class="slider-tab-segment ${t===0?`active`:``}" data-slide-to="${t}">
              <span class="segment-num">0${t+1}</span>
              <span class="segment-title">${e.title}</span>
              <div class="segment-progress"></div>
            </button>
          `).join(``)}
        </div>
      </div>
    `}renderSlideHTML(e,t){return`
      <div class="masculine-slide ${t===0?`active`:``}" data-slide-index="${t}">
        <div class="slide-inner">
          ...
          <div class="slide-meta-bar">
            ...
            <a href="${e.domainUrl}" target="_blank" rel="noopener noreferrer" class="slide-domain-link">
              ${e.domain} ↗
            </a>
          </div>
          ...
          <div class="slide-body">
            ...
            <p class="slide-tagline">${e.tagline}</p>
            ...
            <div class="slide-telemetry-grid">
              ${e.telemetry.map(e=>`
                <div class="telemetry-chip">
                  <span class="telemetry-label">${e.label}</span>
                  <span class="telemetry-value">${e.value}</span>
                </div>
              `).join(``)}
            </div>
            ...
            <div class="slide-tags">
              ${e.tags.map(e=>`<span class="slide-tag">${e}</span>`).join(``)}
            </div>

            <!-- Action Buttons -->
            <div class="slide-actions">
              <a href="${e.domainUrl}" target="_blank" rel="noopener noreferrer" class="btn-masculine-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                LAUNCH ${e.domain.toUpperCase()}
              </a>
              <a href="${e.githubUrl}" target="_blank" rel="noopener noreferrer" class="btn-masculine-secondary">
    ...
    `}bindEvents(){let e=this.container.querySelector(`#sliderPrevBtn`),t=this.container.querySelector(`#sliderNextBtn`),n=this.container.querySelectorAll(`.slider-tab-segment`),r=this.container.querySelector(`.masculine-slider-card`);e&&e.addEventListener(`click`,()=>{this.goToSlide(this.currentSlide-1),$.playClick()}),t&&t.addEventListener(`click`,()=>{this.goToSlide(this.currentSlide+1),$.playClick()}),n.forEach(e=>{e.addEventListener(`click`,()=>{let t=parseInt(e.getAttribute(`data-slide-to`),10);this.goToSlide(t),$.playClick()})}),r&&(r.addEventListener(`mouseenter`,()=>{this.isPaused=!0}),r.addEventListener(`mouseleave`,()=>{this.isPaused=!1}),r.addEventListener(`touchstart`,e=>{this.touchStartX=e.changedTouches[0].screenX},{passive:!0}),r.addEventListener(`touchend`,e=>{this.touchEndX=e.changedTouches[0].screenX,this.handleSwipe()},{passive:!0}))}handleSwipe(){let e=this.touchStartX-this.touchEndX;Math.abs(e)>45&&(e>0?this.goToSlide(this.currentSlide+1):this.goToSlide(this.currentSlide-1),$.playClick())}goToSlide(e){this.currentSlide=e<0?this.totalSlides-1:e>=this.totalSlides?0:e,this.updateUI()}updateUI(){let e=this.container.querySelector(`#sliderTrack`),t=this.container.querySelector(`#sliderCounter`),n=this.container.querySelectorAll(`.masculine-slide`),r=this.container.querySelectorAll(`.slider-tab-segment`);e&&(e.style.transform=`translateX(-${this.currentSlide*100}%)`),t&&(t.textContent=`0${this.currentSlide+1} / 0${this.totalSlides}`),n.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentSlide)}),r.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentSlide)})}startAutoPlay(){this.autoPlayInterval&&clearInterval(this.autoPlayInterval),this.autoPlayInterval=setInterval(()=>{this.isPaused||this.goToSlide(this.currentSlide+1)},6e3)}},sl=class{constructor(e){this.container=document.getElementById(e),this.currentIndex=0,this.timer=null,this.slideInterval=null,this.isPaused=!1,this.totalSlides=4;let t=Intl.DateTimeFormat().resolvedOptions().timeZone||`Asia/Dhaka`,n=this.resolveTimezoneFallback(t);this.telemetryData={ip:`Securing...`,city:n.city||`Dhaka`,country:n.country||`Bangladesh`,countryCode:n.countryCode||`BD`,flagEmoji:n.flagEmoji||`🇧🇩`,flagUrl:n.flagUrl||`https://flagcdn.com/w40/bd.png`,timezone:t,utcOffset:``,localTime:`--:--:-- --`,localDate:`---, --- --, ----`,dayOfWeek:`---`,latency:`12ms`},this.container&&this.init()}async init(){this.updateClock(),this.render(),this.startSliding(),this.timer=setInterval(()=>this.updateClock(),1e3),await this.fetchGeoData()}resolveTimezoneFallback(e){let t={"Asia/Dhaka":{city:`Dhaka`,country:`Bangladesh`,countryCode:`BD`,flagEmoji:`🇧🇩`,flagUrl:`https://flagcdn.com/w40/bd.png`},"Europe/London":{city:`London`,country:`United Kingdom`,countryCode:`GB`,flagEmoji:`🇬🇧`,flagUrl:`https://flagcdn.com/w40/gb.png`},"America/New_York":{city:`New York`,country:`United States`,countryCode:`US`,flagEmoji:`🇺🇸`,flagUrl:`https://flagcdn.com/w40/us.png`},"America/Los_Angeles":{city:`Los Angeles`,country:`United States`,countryCode:`US`,flagEmoji:`🇺🇸`,flagUrl:`https://flagcdn.com/w40/us.png`},"America/Chicago":{city:`Chicago`,country:`United States`,countryCode:`US`,flagEmoji:`🇺🇸`,flagUrl:`https://flagcdn.com/w40/us.png`},"America/Toronto":{city:`Toronto`,country:`Canada`,countryCode:`CA`,flagEmoji:`🇨🇦`,flagUrl:`https://flagcdn.com/w40/ca.png`},"Asia/Kolkata":{city:`Kolkata`,country:`India`,countryCode:`IN`,flagEmoji:`🇮🇳`,flagUrl:`https://flagcdn.com/w40/in.png`},"Asia/Dubai":{city:`Dubai`,country:`United Arab Emirates`,countryCode:`AE`,flagEmoji:`🇦🇪`,flagUrl:`https://flagcdn.com/w40/ae.png`},"Asia/Riyadh":{city:`Riyadh`,country:`Saudi Arabia`,countryCode:`SA`,flagEmoji:`🇸🇦`,flagUrl:`https://flagcdn.com/w40/sa.png`},"Asia/Singapore":{city:`Singapore`,country:`Singapore`,countryCode:`SG`,flagEmoji:`🇸🇬`,flagUrl:`https://flagcdn.com/w40/sg.png`},"Asia/Tokyo":{city:`Tokyo`,country:`Japan`,countryCode:`JP`,flagEmoji:`🇯🇵`,flagUrl:`https://flagcdn.com/w40/jp.png`},"Asia/Kuala_Lumpur":{city:`Kuala Lumpur`,country:`Malaysia`,countryCode:`MY`,flagEmoji:`🇲🇾`,flagUrl:`https://flagcdn.com/w40/my.png`},"Europe/Berlin":{city:`Berlin`,country:`Germany`,countryCode:`DE`,flagEmoji:`🇩🇪`,flagUrl:`https://flagcdn.com/w40/de.png`},"Europe/Paris":{city:`Paris`,country:`France`,countryCode:`FR`,flagEmoji:`🇫🇷`,flagUrl:`https://flagcdn.com/w40/fr.png`},"Europe/Amsterdam":{city:`Amsterdam`,country:`Netherlands`,countryCode:`NL`,flagEmoji:`🇳🇱`,flagUrl:`https://flagcdn.com/w40/nl.png`},"Australia/Sydney":{city:`Sydney`,country:`Australia`,countryCode:`AU`,flagEmoji:`🇦🇺`,flagUrl:`https://flagcdn.com/w40/au.png`},"Australia/Melbourne":{city:`Melbourne`,country:`Australia`,countryCode:`AU`,flagEmoji:`🇦🇺`,flagUrl:`https://flagcdn.com/w40/au.png`}};if(e&&t[e])return t[e];let n=(e||``).split(`/`);return{city:n[1]?.replace(/_/g,` `)||`Global`,country:n[0]?.replace(/_/g,` `)||`Web Node`,countryCode:``,flagEmoji:`🌐`,flagUrl:``}}async fetchGeoData(){let e=!1;try{let t=await fetch(`https://ipwho.is/`,{cache:`no-cache`});if(t.ok){let n=await t.json();if(n&&n.success!==!1&&n.country){let t=(n.country_code||``).toUpperCase();this.telemetryData.ip=n.ip||`Secured IP`,this.telemetryData.city=n.city||this.telemetryData.city,this.telemetryData.country=n.country||this.telemetryData.country,this.telemetryData.countryCode=t,this.telemetryData.flagEmoji=n.flag?.emoji||this.getCountryFlag(t),this.telemetryData.flagUrl=t?`https://flagcdn.com/w40/${t.toLowerCase()}.png`:``,this.telemetryData.timezone=n.timezone?.id||this.telemetryData.timezone,this.telemetryData.utcOffset=n.timezone?.utc||``,e=!0}}}catch{}if(!e)try{let t=await fetch(`https://freeipapi.com/api/json`,{cache:`no-cache`});if(t.ok){let n=await t.json();if(n&&n.countryName){let t=(n.countryCode||``).toUpperCase();this.telemetryData.ip=n.ipAddress||`Secured IP`,this.telemetryData.city=n.cityName||this.telemetryData.city,this.telemetryData.country=n.countryName||this.telemetryData.country,this.telemetryData.countryCode=t,this.telemetryData.flagEmoji=this.getCountryFlag(t),this.telemetryData.flagUrl=t?`https://flagcdn.com/w40/${t.toLowerCase()}.png`:``,this.telemetryData.timezone=n.timeZone||this.telemetryData.timezone,e=!0}}}catch{}if(!e)try{let t=await fetch(`https://ipapi.co/json/`,{cache:`no-cache`});if(t.ok){let n=await t.json();if(n&&(n.country_name||n.country)){let t=(n.country_code||n.country||``).toUpperCase();this.telemetryData.ip=n.ip||`Secured IP`,this.telemetryData.city=n.city||this.telemetryData.city,this.telemetryData.country=n.country_name||n.country||this.telemetryData.country,this.telemetryData.countryCode=t,this.telemetryData.flagEmoji=this.getCountryFlag(t),this.telemetryData.flagUrl=t?`https://flagcdn.com/w40/${t.toLowerCase()}.png`:``,this.telemetryData.timezone=n.timezone||this.telemetryData.timezone,this.telemetryData.utcOffset=n.utc_offset||``,e=!0}}}catch{}this.updateClock(),this.updateLiveTelemetryDOM()}getCountryFlag(e){if(!e||e.length!==2)return`🌐`;try{let t=e.toUpperCase().split(``).map(e=>127397+e.charCodeAt(0));return String.fromCodePoint(...t)}catch{return`🌐`}}updateClock(){try{let e=new Date,t=new Intl.DateTimeFormat(`en-US`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!0,timeZone:this.telemetryData.timezone}).format(e),n=new Intl.DateTimeFormat(`en-US`,{month:`short`,day:`numeric`,year:`numeric`,timeZone:this.telemetryData.timezone}).format(e),r=new Intl.DateTimeFormat(`en-US`,{weekday:`long`,timeZone:this.telemetryData.timezone}).format(e);this.telemetryData.localTime=t,this.telemetryData.localDate=n,this.telemetryData.dayOfWeek=r;let i=this.container?.querySelectorAll(`.live-time-ticker`),a=this.container?.querySelectorAll(`.live-date-ticker`),o=this.container?.querySelectorAll(`.live-day-ticker`);i?.forEach(e=>{e.textContent=t}),a?.forEach(e=>{e.textContent=n}),o?.forEach(e=>{e.textContent=r})}catch{let e=new Date;this.telemetryData.localTime=e.toLocaleTimeString(),this.telemetryData.localDate=e.toLocaleDateString()}}updateLiveTelemetryDOM(){if(!this.container)return;let e=this.container.querySelector(`#hudGeoBadge`),t=this.container.querySelector(`#hudGeoCity`),n=this.container.querySelector(`#hudGeoCountry`),r=this.container.querySelector(`#hudGeoIp`),i=this.container.querySelector(`#hudTzMeta`);e&&(e.innerHTML=this.renderFlagBadgeHTML()),t&&(t.textContent=this.telemetryData.city),n&&(n.textContent=this.telemetryData.country),r&&(r.textContent=`IP: ${this.telemetryData.ip}`),i&&(i.textContent=`${this.telemetryData.timezone} ${this.telemetryData.utcOffset}`.trim())}renderFlagBadgeHTML(){return this.telemetryData.flagUrl&&this.telemetryData.countryCode?`
      ...
      `:`<span>${this.telemetryData.flagEmoji||`🌐`} VISITOR ORIGIN</span>`}render(){if(!this.container)return;this.container.innerHTML=`
    ...
    `;let e=document.getElementById(`uniqueTelemetryHud`);e&&(e.addEventListener(`mouseenter`,()=>{this.isPaused=!0}),e.addEventListener(`mouseleave`,()=>{this.isPaused=!1}));let t=document.getElementById(`hudPrevSlide`),n=document.getElementById(`hudNextSlide`);t?.addEventListener(`click`,e=>{e.stopPropagation(),this.prevSlide()}),n?.addEventListener(`click`,e=>{e.stopPropagation(),this.nextSlide()}),this.container.querySelectorAll(`.hud-prog-dot`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.getAttribute(`data-index`),10);this.goToSlide(n)})})}startSliding(){this.slideInterval&&clearInterval(this.slideInterval),this.slideInterval=setInterval(()=>{this.isPaused||this.nextSlide()},3500)}nextSlide(){this.currentIndex=(this.currentIndex+1)%this.totalSlides,this.updateSlideUI()}prevSlide(){this.currentIndex=(this.currentIndex-1+this.totalSlides)%this.totalSlides,this.updateSlideUI()}goToSlide(e){this.currentIndex=e,this.updateSlideUI()}updateSlideUI(){let e=document.getElementById(`hudSlideTrack`),t=this.container?.querySelectorAll(`.hud-telemetry-slide`),n=this.container?.querySelectorAll(`.hud-prog-dot`);e&&(e.style.transform=`translateX(-${this.currentIndex*100}%)`),t&&t.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentIndex)}),n&&n.forEach((e,t)=>{e.classList.toggle(`active`,t===this.currentIndex)})}},cl=`https://api.github.com/users/samir-60/repos?sort=updated&per_page=100`,ll=`samir_github_repos_cache_v2`,ul=6e5,dl={TypeScript:`#38bdf8`,JavaScript:`#fbbf24`,Python:`#3b82f6`,HTML:`#f97316`,CSS:`#a855f7`,"C++":`#ec4899`,C:`#64748b`,Go:`#06b6d4`,Rust:`#ef4444`,Dart:`#10b981`};function fl(e,t){let n=(e||``).toLowerCase().replace(/[^a-z0-9]/g,``);return n.includes(`softyx`)&&n.includes(`fraud`)?`./assets/projects/fraud_ui.jpg`:n.includes(`softyx`)?`./assets/projects/softyx_ui.jpg`:n.includes(`profix`)||n.includes(`shine`)?`./assets/projects/profix_ui.jpg`:n.includes(`biblio`)||n.includes(`book`)?`./assets/projects/bibliodrop_ui.jpg`:n.includes(`study`)||n.includes(`sync`)?`./assets/projects/studysync_ui.jpg`:n.includes(`fraud`)||n.includes(`cyber`)||n.includes(`security`)?`./assets/projects/fraud_ui.jpg`:n.includes(`protfolio`)||n.includes(`portfolio`)||n.includes(`samir`)?`./assets/projects/portfolio_ui.jpg`:t===`Python`?`./assets/projects/fraud_ui.jpg`:t===`JavaScript`||t===`HTML`?`./assets/projects/studysync_ui.jpg`:`./assets/projects/portfolio_ui.jpg`}async function pl(e){let t=_l();t&&t.length>0&&e&&e(t,!0);try{let r=await fetch(cl,{headers:{Accept:`application/vnd.github.v3+json`}});if(!r.ok){console.warn(`GitHub API returned status ${r.status}. Using fallback project list.`),!t&&e&&e(n,!1);return}let i=await r.json();if(!Array.isArray(i))return;let a=ml(i,n);vl(a),e&&e(a,!1)}catch(r){console.warn(`Live GitHub auto-sync network error, using fallback:`,r),!t&&e&&e(n,!1)}}function ml(e,t){let n=[...t];return new Set(t.map(e=>e.githubUrl?.toLowerCase()).filter(Boolean)),new Set(t.map(e=>e.id?.toLowerCase().replace(/[^a-z0-9]/g,``))),e.filter(e=>!e.fork||e.stargazers_count>0).forEach(e=>{let t=e.html_url.toLowerCase(),r=e.name.toLowerCase().replace(/[^a-z0-9]/g,``),i=n.findIndex(e=>e.githubUrl&&e.githubUrl.toLowerCase()===t||e.id&&e.id.toLowerCase().replace(/[^a-z0-9]/g,``)===r);if(i!==-1)n[i]={...n[i],stars:e.stargazers_count,forks:e.forks_count,updatedAt:e.pushed_at||e.updated_at,githubUrl:e.html_url,liveUrl:n[i].liveUrl||e.homepage||e.html_url};else{let t=hl(e);n.push(t)}}),n}function hl(e){let t=e.language||`TypeScript`,n=dl[t]||`#38bdf8`,r=fl(e.name,t),i=e.name.replace(/[-_]/g,` `).replace(/\b\w/g,e=>e.toUpperCase()),a=`fullstack`,o=e.name.toLowerCase();(e.description||``).toLowerCase();let s=e.topics||[];s.includes(`ai`)||s.includes(`machine-learning`)||o.includes(`ai`)||o.includes(`research`)||t===`Python`?a=`ai`:(s.includes(`security`)||s.includes(`cybersecurity`)||s.includes(`tool`)||s.includes(`cli`)||o.includes(`fraud`)||o.includes(`checker`)||o.includes(`tool`))&&(a=`tools`);let c=[t,...s.slice(0,3).map(e=>e.charAt(0).toUpperCase()+e.slice(1)),`GitHub Live`];return{id:e.name.toLowerCase(),title:`${i} — GitHub Live Repo`,category:a,subtitle:e.description||`Open-source engineering repository built by Samir Qureshi`,featured:!1,badge:`Live GitHub Repo`,shortDescription:e.description||`Active open-source repository published on GitHub. Built with ${t} and maintained by Samir.`,fullDescription:`${e.description||`Open-source software project by Samir Qureshi.`}\n\nThis project is automatically synchronized in real-time from GitHub repository @samir-60/${e.name}.`,image:r,tags:c.slice(0,4),stats:{stars:`${e.stargazers_count} Stars`,language:t,updated:gl(e.pushed_at||e.updated_at)},highlights:[`Auto-synced repository from https://github.com/samir-60/${e.name}`,`Primary Architecture: ${t}`,`Live GitHub Stars: ${e.stargazers_count} • Forks: ${e.forks_count}`,`Last commit activity: ${new Date(e.pushed_at||e.updated_at).toLocaleDateString()}`],githubUrl:e.html_url,liveUrl:e.homepage||e.html_url,color:n,isAutoSynced:!0}}function gl(e){if(!e)return`Active`;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/864e5);return n===0?`Updated today`:n===1?`Updated yesterday`:n<30?`Updated ${n}d ago`:`Updated ${Math.floor(n/30)}mo ago`}function _l(){try{let e=localStorage.getItem(ll);if(!e)return null;let t=JSON.parse(e);if(Date.now()-t.timestamp<ul)return t.data}catch{return null}return null}function vl(e){try{localStorage.setItem(ll,JSON.stringify({timestamp:Date.now(),data:e}))}catch{}}document.addEventListener(`DOMContentLoaded`,()=>{new sl(`geoTelemetryMount`);try{new el(`three-hero-canvas`)}catch(e){console.warn(`3D Hero Canvas Fallback:`,e)}try{new tl(`skills-galaxy-canvas`)}catch(e){console.warn(`3D Skills Canvas Fallback:`,e)}let e=new rl(`projectModal`,`projectModalBackdrop`,`projectModalContent`),t=new il(`resumeModal`,`resumeModalBackdrop`,`openResumeBtn`);new nl(`terminalBody`,`terminalInput`),new ol(`liveVenturesSlider`),yl(n,e),bl(r.categories),xl(i),pl(t=>{yl(t,e);let n=document.getElementById(`repoCountLabel`);n&&(n.textContent=`${t.length} REPOSITORIES SYNCED`)}),Sl(),Cl(),wl(),Tl(),El(),Dl(),Ol(),kl(t),Al(),new al});function yl(e,t){let n=document.getElementById(`projectsGrid`);if(!n)return;n.innerHTML=e.map(e=>`
    <div class="project-card tilt-card" data-category="${e.category}" data-id="${e.id}">
      <div class="card-glare"></div>
      <div class="project-img-wrap">
        <div class="project-badge-tag" style="background: ${e.color}22; color: ${e.color}; border: 1px solid ${e.color}55;">
          ${e.badge}
        </div>
        <img src="${e.image}" alt="${e.title}" class="project-img" loading="lazy" />
      </div>
      <div class="project-body">
        <h3 class="project-title">${e.title}</h3>
        <p class="project-short-desc">${e.shortDescription}</p>
        <div class="project-tech-tags">
          ${e.tags.slice(0,4).map(e=>`<span class="tech-tag">${e}</span>`).join(``)}
        </div>
        <div class="project-footer">
          ...
          <span style="font-size: 0.8rem; color: var(--text-muted); font-family: var(--font-mono);">
            ${e.stats.stars||e.stats.latency||e.stats.fps||`Live Demo`}
          </span>
        </div>
      </div>
    </div>
  `).join(``);let r=n.querySelectorAll(`.project-card`);r.forEach(n=>{n.addEventListener(`click`,()=>{let r=n.getAttribute(`data-id`),i=e.find(e=>e.id===r);i&&t&&t.open(i)})});let i=document.querySelectorAll(`.filter-btn`);i.forEach(e=>{e.addEventListener(`click`,()=>{i.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),$.playClick();let t=e.getAttribute(`data-filter`);r.forEach(e=>{let n=e.getAttribute(`data-category`);t===`all`||n===t?e.style.display=`flex`:e.style.display=`none`})})})}function bl(e){let t=document.getElementById(`skillsCategoriesList`);t&&(t.innerHTML=e.map(e=>`
    <div class="skill-category-card">
      <div class="skill-cat-header">
        <h3 class="skill-cat-title" style="color: ${e.color};">${e.title}</h3>
      </div>
        ...
        ${e.skills.map(t=>`
          <div class="skill-bar-item">
            <div class="skill-bar-meta">
              <span>${t.name}</span>
              <span style="color: ${e.color}; font-family: var(--font-mono);">${t.level}%</span>
            </div>
            <div class="skill-bar-track">
              <div class="skill-bar-fill" data-level="${t.level}" style="background: linear-gradient(90deg, ${e.color}88, ${e.color});"></div>
            </div>
          </div>
        `).join(``)}
      </div>
    </div>
  `).join(``))}function xl(e){let t=document.getElementById(`experienceTimeline`);t&&(t.innerHTML=e.map(e=>`
    <div class="timeline-item">
      ...
      <div class="timeline-card">
        ...
        <ul class="timeline-bullets">
          ${e.achievements.map(e=>`<li><span class="bullet">▹</span> ${e}</li>`).join(``)}
        </ul>
        <div class="project-tech-tags">
  ...
  `).join(``))}function Sl(){let e=document.getElementById(`typewriterTarget`);if(!e)return;let t=[`Full-Stack Web Developer`,`Cybersecurity Expert & Fraud Analyst`,`Founder of Softyx (softyx.shop)`,`B.Sc. CSE Student @ Metropolitan University`,`Architect of Profix & Shine UK`,`Academic AI Researcher & Open-Source Builder`],n=0,r=0,i=!1,a=75;function o(){let s=t[n];i?(e.textContent=s.substring(0,r-1),r--,a=35):(e.textContent=s.substring(0,r+1),r++,a=75),!i&&r===s.length?(i=!0,a=2e3):i&&r===0&&(i=!1,n=(n+1)%t.length,a=350),setTimeout(o,a)}o()}function Cl(){let e=document.querySelectorAll(`.stat-number`),t=!1,n=new IntersectionObserver(n=>{n.forEach(n=>{n.isIntersecting&&!t&&(t=!0,e.forEach(e=>{let t=parseInt(e.getAttribute(`data-target`),10),n=e.innerText.replace(/[0-9]/g,``),r=0,i=t/60,a=setInterval(()=>{r+=i,r>=t?(e.innerText=t+n,clearInterval(a)):e.innerText=Math.floor(r)+n},25)}))})},{threshold:.3}),r=document.querySelector(`.stats-banner`);r&&n.observe(r)}function wl(){let e=document.querySelectorAll(`.skill-bar-fill`),t=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&e.forEach(e=>{let t=e.getAttribute(`data-level`);e.style.width=`${t}%`})})},{threshold:.2}),n=document.getElementById(`skills`);n&&t.observe(n)}function Tl(){let e=document.querySelectorAll(`.story-tab-btn`),t=document.querySelectorAll(`.story-tab-content`);e.forEach(n=>{n.addEventListener(`click`,()=>{e.forEach(e=>e.classList.remove(`active`)),t.forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),$.playClick();let r=n.getAttribute(`data-tab`),i=document.getElementById(`tab-${r}`);i&&i.classList.add(`active`)})})}function El(){let e=document.getElementById(`themeDropdown`),t=document.getElementById(`themeBtn`),n=document.querySelectorAll(`.theme-item`),r=localStorage.getItem(`samir_portfolio_theme`)||`obsidian`;document.documentElement.setAttribute(`data-theme`,r),i(r),t&&e&&(t.addEventListener(`click`,t=>{t.stopPropagation(),e.classList.toggle(`open`),$.playClick()}),document.addEventListener(`click`,()=>{e.classList.remove(`open`)})),n.forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-set-theme`);document.documentElement.setAttribute(`data-theme`,n),localStorage.setItem(`samir_portfolio_theme`,n),i(n),e&&e.classList.remove(`open`),$.playChime()})});function i(e){n.forEach(t=>{t.getAttribute(`data-set-theme`)===e?t.classList.add(`active`):t.classList.remove(`active`)})}}function Dl(){let e=document.getElementById(`soundToggleBtn`),t=document.getElementById(`soundIconOn`),n=document.getElementById(`soundIconOff`);if(!e)return;function r(){let e=$.isMuted();t&&n&&(t.style.display=e?`none`:`block`,n.style.display=e?`block`:`none`)}r(),e.addEventListener(`click`,()=>{$.toggleSound(),r()})}function Ol(){let e=document.getElementById(`contactForm`),n=document.getElementById(`contactSubmitBtn`),r=document.getElementById(`submitBtnText`),i=document.getElementById(`formSuccess`),a=document.getElementById(`formError`),o=document.getElementById(`copyEmailBtn`),s=document.getElementById(`copyEmailText`),c=`qureshsamir145@gmail.com`;e&&e.addEventListener(`submit`,async o=>{o.preventDefault();let s=document.getElementById(`senderName`)?.value.trim()||`Valued Contact`,l=document.getElementById(`senderEmail`)?.value.trim(),u=document.getElementById(`senderSubject`)?.value.trim()||`Portfolio Inquiry`,d=document.getElementById(`senderMessage`)?.value.trim();if(!(!l||!d)){n&&(n.disabled=!0),r&&(r.textContent=`Sending Message...`),i&&(i.style.display=`none`),a&&(a.style.display=`none`);try{let n=!1;try{let e=await fetch(`/api/contact/`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:s,email:l,subject:u,message:d})});!e.ok&&e.status===404&&(e=await fetch(`/api/contact`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:s,email:l,subject:u,message:d})})),e.ok&&(n=!0)}catch(e){console.log(`Secure Direct Backend offline, using fallback provider...`,e)}if(!n){let e={name:s,email:l,_replyto:l,_subject:`New Portfolio Message from ${s}: ${u}`,subject:u,message:d,_captcha:`false`,_autoresponse:`Hi ${s},\n\nThank you for reaching out to Samir Qureshi!\n\nYour message regarding "${u}" has been received. Samir will review your note and get back to you directly at ${l} as soon as possible.\n\nBest regards,\nSamir Qureshi\nB.Sc. in CSE (Metropolitan University, Sylhet)\nFull-Stack Web Developer & Cybersecurity Specialist\nPortfolio: https://github.com/samir-60\nDirect Email: ${c}`,_template:`table`};(await fetch(`https://formsubmit.co/ajax/${c}`,{method:`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:JSON.stringify(e)})).ok&&(n=!0)}if(n)$.playChime(),t({particleCount:120,spread:80,origin:{y:.6},colors:[`#38bdf8`,`#818cf8`,`#c084fc`,`#10b981`]}),i&&(i.style.display=`block`,i.innerHTML=`
              <strong>✓ Message Sent Directly to Samir!</strong><br />
              Your message was delivered directly to <code>${c}</code> and a confirmation copy has been sent to your email.
            `),e.reset();else throw Error(`All dispatch methods failed`)}catch(e){console.warn(`Contact form error:`,e),a&&(a.style.display=`block`),window.location.href=`mailto:${c}?subject=${encodeURIComponent(u)}&body=${encodeURIComponent(`From: ${s} (${l})\n\n${d}`)}`}finally{n&&(n.disabled=!1),r&&(r.textContent=`Send Message`)}}}),o&&s&&o.addEventListener(`click`,()=>{$.playClick(),navigator.clipboard.writeText(c).then(()=>{s.textContent=`✓ Copied: qureshsamir145@gmail.com`,setTimeout(()=>{s.textContent=`Copy qureshsamir145@gmail.com`},3e3)}).catch(()=>{s.textContent=c})})}function kl(e){let t=document.querySelectorAll(`.nav-link`),n=document.querySelectorAll(`.mobile-drawer-link`),r=document.querySelectorAll(`section[id]`),i=document.getElementById(`backToTopBtn`),a=document.getElementById(`mobileNavToggle`),o=document.getElementById(`mobileNavDrawer`),s=document.getElementById(`mobileNavBackdrop`),c=document.getElementById(`mobileDrawerClose`),l=document.getElementById(`mobileResumeBtn`);function u(){o&&(o.classList.add(`open`),o.setAttribute(`aria-hidden`,`false`),a&&(a.classList.add(`active`),a.setAttribute(`aria-expanded`,`true`)),s&&s.classList.add(`open`),document.body.classList.add(`modal-locked`),$.playModalOpen())}function d(){o&&(o.classList.remove(`open`),o.setAttribute(`aria-hidden`,`true`),a&&(a.classList.remove(`active`),a.setAttribute(`aria-expanded`,`false`)),s&&s.classList.remove(`open`),document.body.classList.remove(`modal-locked`))}a&&a.addEventListener(`click`,e=>{e.stopPropagation(),o?.classList.contains(`open`)?(d(),$.playClick()):u()}),c&&c.addEventListener(`click`,()=>{d(),$.playClick()}),s&&s.addEventListener(`click`,()=>{d(),$.playClick()}),n.forEach(e=>{e.addEventListener(`click`,()=>{d(),$.playClick()})}),l&&l.addEventListener(`click`,()=>{if(d(),e)e.open();else{let e=document.getElementById(`resumeModal`),t=document.getElementById(`resumeModalBackdrop`);e&&t&&($.playModalOpen(),document.body.classList.add(`modal-locked`),e.classList.add(`active`),t.classList.add(`active`))}}),window.addEventListener(`scroll`,()=>{let e=window.pageYOffset;r.forEach(r=>{let i=r.offsetHeight,a=r.offsetTop-140,o=r.getAttribute(`id`);e>a&&e<=a+i&&(t.forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`href`)===`#${o}`)}),n.forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`href`)===`#${o}`)}))})},{passive:!0}),i&&i.addEventListener(`click`,()=>{$.playClick(),window.scrollTo({top:0,behavior:`smooth`})})}function Al(){let e=document.getElementById(`liveClockDisplay`);if(!e)return;function t(){e.textContent=`Live (UTC): `+new Date().toUTCString().split(` `).slice(4,5)[0]+` UTC`}t(),setInterval(t,1e3)}